...
/* USER CODE BEGIN Header_StartMotor1 */
/**
  * @brief  Function implementing the Motor1 thread.
...
/* USER CODE BEGIN Header_StartMotor2 */
/**
* @brief Function implementing the Motor2 thread.
* @param argument: Not used
* @retval None
*/
